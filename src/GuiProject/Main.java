...
//        Image atkOperatorImage = new Image(atkImage);
...
//        defOpPane.setCenter(defOpImage);
     ...
     * @return
     */
    private String[] chooseAttackOp(Stage primaryStage, Button chooseAtkOp) {
     ...
     * @return
     */
    private String[] chooseDefOp(Stage primaryStage, Button chooseDefOp) {
